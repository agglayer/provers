...
1. Follow the instructions [here](https://docs.succinct.xyz/docs/sp1/prover-network/quickstart#step-1-key-setup) to use Foundry to generate a new private key or retrieve an existing one.
