...
impl<ContractsClient> AggchainProofBuilder<ContractsClient> {
            ...
            + L1RollupConfigHashFetcher,
    {
        ...
        let _block_range = request.aggchain_proof_inputs.last_proven_block..request.end_block; // TODO: Handle +-1

        println!(">>>>>>>>>> AggchainProofBuilder RetrieveChainData Checkpoint 02");
        // Fetch from RPCs
    ...
    ContractsClient: AggchainContractsClient + Send + Sync + 'static,
{
    ...
    fn call(&mut self, req: AggchainProofBuilderRequest) -> Self::Future {
        ...
        async move {
            ...
            println!(">>>>>>>>>> AggchainProofBuilder Checkpoint 03");
