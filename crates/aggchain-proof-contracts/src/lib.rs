...
impl AggchainProofContractsClient {
    ...
    pub async fn get_l2_output_at_block(
        &self,
        block_number: u64,
    ) -> Result<L2OutputAtBlock, Error> {
...
mod tests {
    ...
    use crate::AggchainProofContractsClient;
    ...
    fn parsing_l2_output_root() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let result = AggchainProofContractsClient::parse_l2_output_root(
