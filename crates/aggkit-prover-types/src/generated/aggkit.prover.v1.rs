...
pub struct FetchAggchainProofRequest {
...
pub struct FetchAggchainProofResponse {
    /// The aggchain proof.
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FetchAggchainProofError {
...
pub mod aggchain_proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn fetch_aggchain_proof(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchAggchainProofRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FetchAggchainProofResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/aggkit.prover.v1.AggchainProofService/FetchAggchainProof",
            );
...
pub mod aggchain_proof_service_server {
    ...
    pub trait AggchainProofService: std::marker::Send + std::marker::Sync + 'static {
        /// Fetches a auth-proof for a given start_block.
        async fn fetch_aggchain_proof(
            &self,
            request: tonic::Request<super::FetchAggchainProofRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FetchAggchainProofResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/aggkit.prover.v1.AggchainProofService/FetchAggchainProof" => {
                    ...
                    struct FetchAggchainProofSvc<T: AggchainProofService>(pub Arc<T>);
                    impl<
                        T: AggchainProofService,
                    > tonic::server::UnaryService<super::FetchAggchainProofRequest>
                    for FetchAggchainProofSvc<T> {
                        type Response = super::FetchAggchainProofResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AggchainProofService>::fetch_aggchain_proof(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = FetchAggchainProofSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
