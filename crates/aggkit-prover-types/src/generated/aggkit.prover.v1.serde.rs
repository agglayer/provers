...
impl serde::Serialize for GenerateAggchainProofRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.ger_inclusion_proofs.is_empty() {
            len += 1;
        }
        ...
        if !self.ger_inclusion_proofs.is_empty() {
            struct_ser.serialize_field("gerInclusionProofs", &self.ger_inclusion_proofs)?;
        }
        if !self.imported_bridge_exits.is_empty() {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "gerInclusionProofs" | "ger_inclusion_proofs" => Ok(GeneratedField::GerInclusionProofs),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut ger_inclusion_proofs__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::GerInclusionProofs => {
                            if ger_inclusion_proofs__.is_some() {
                                return Err(serde::de::Error::duplicate_field("gerInclusionProofs"));
                            }
                            ger_inclusion_proofs__ = Some(
                ...
                Ok(GenerateAggchainProofRequest {
                    ...
                    ger_inclusion_proofs: ger_inclusion_proofs__.unwrap_or_default(),
